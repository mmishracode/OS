...
Now I am trying to run the code but it says no processes and no file input.

Also I would like to know the gcc code

Which File to Consider ALL 3 or just 2.
